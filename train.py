...
def get_parser():
    ...
    parser.add_argument("--n_bbox", type=int, default=36,
                        help="number of extracted bounding boxes per image")
    parser.add_argument("--spatial_feat", type=int, default=6,
                        help="number of spatial information")
    ...
    parser.add_argument("--mmodal", type=str, default="",
                        help="Modality (modal1-modal2: cap-img)")
    parser.add_argument("--imgset", type=str, default="",
                        help="name of the image source, eg. coco36")
